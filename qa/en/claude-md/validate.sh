...
SKILL_DIR="$(cd "$QA_DIR/../../../skills/en/claude-md" && pwd)"
...
mkdir "$CHECK_ROOT/claude-md"
sed '/^disable-model-invocation: true$/d' "$SKILL_DIR/SKILL.md" > "$CHECK_ROOT/claude-md/SKILL.md"
run_local_or_npx skills-ref validate "$CHECK_ROOT/claude-md"
...
printf 'OK: claude-md validation passed\n'
