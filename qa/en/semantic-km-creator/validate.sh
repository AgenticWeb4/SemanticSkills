...
SKILL_DIR="$(cd "$QA_DIR/../../../skills/en/semantic-km-creator" && pwd)"
...
required_template = [
    ...
    "Interface evidence (explicit)", "Pending", ':disabled="!allApproved()"',
    "Understand:", "Decision evidence:", "YAGNI:", "View '+s.label+' decision guidance",
...
required_review = [
    ...
    "basis", "confidence", "status", "risk", "approved:true", "Fixed Guidance",
    "Approval is user-owned", "YAGNI", "hover",
]
