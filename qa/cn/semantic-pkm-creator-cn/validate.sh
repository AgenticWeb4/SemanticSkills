...
SKILL_DIR="$(cd "$QA_DIR/../../../skills/cn/semantic-pkm-creator-cn" && pwd)"
...
check_references() {
  rg -q '^name: semantic-pkm-creator-cn$' "$SKILL_DIR/SKILL.md" || fail "frontmatter name mismatch"
...
printf 'OK: semantic-pkm-creator-cn validation passed\n'
