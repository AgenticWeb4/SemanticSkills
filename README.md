...
| `jackson-concept-design` | 0.3.0 | **Jackson Concept Design** — model independent concepts and compose application behavior through when/where/then synchronizations | [details](docs/skills/jackson-concept-design.md) · [changelog](qa/jackson-concept-design/CHANGELOG.md) |
| `jackson-concept-prd` | 0.2.0 | **Jackson Concept PRD** — transcribe a confirmed concept model into a central overall PRD plus wyx-compatible colocated CONCEPT.md/SYNCS.md specs | [details](docs/skills/jackson-concept-prd.md) · [changelog](qa/jackson-concept-prd/CHANGELOG.md) |
| `jackson-concept-implementation` | 0.2.0 | **Jackson Concept Implementation** — map a confirmed concept model onto a modular monolith (concept modules + causal syncs, colocated specs) | [details](docs/skills/jackson-concept-implementation.md) · [changelog](qa/jackson-concept-implementation/CHANGELOG.md) |
| `jackson-concept-audit` | 0.2.0 | **Jackson Concept Audit** — read-only five-dimension audit with calibrated drift checklists and cross-spec validation, with fix routing | [details](docs/skills/jackson-concept-audit.md) · [changelog](qa/jackson-concept-audit/CHANGELOG.md) |
