...
| `jackson-concept-design` | 0.2.0 | **Jackson Concept Design** — model independent concepts and compose application behavior through synchronizations | [details](docs/skills/jackson-concept-design.md) · [changelog](qa/jackson-concept-design/CHANGELOG.md) |
| `jackson-concept-prd` | 0.1.0 | **Jackson Concept PRD** — transcribe a confirmed concept model into overall, per-concept, and flow-grouped PRD documents | [details](docs/skills/jackson-concept-prd.md) · [changelog](qa/jackson-concept-prd/CHANGELOG.md) |
| `jackson-concept-implementation` | 0.1.0 | **Jackson Concept Implementation** — map a confirmed concept model onto a modular monolith (concept modules + sync mediators) | [details](docs/skills/jackson-concept-implementation.md) · [changelog](qa/jackson-concept-implementation/CHANGELOG.md) |
| `jackson-concept-audit` | 0.1.0 | **Jackson Concept Audit** — read-only five-dimension audit of code against the concept model, with fix routing | [details](docs/skills/jackson-concept-audit.md) · [changelog](qa/jackson-concept-audit/CHANGELOG.md) |
