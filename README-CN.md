...
| `huawei-cloud-cost-estimation` | 3.2.0 | **华为云成本估算与受控开通** — 有界渐进询价与白名单资源创建 | [详情](docs/skills/huawei-cloud-cost-estimation.md) · [changelog](qa/huawei-cloud-cost-estimation/CHANGELOG.zh.md) |
