...
syncs/            # composition layer, one module per flow
...
retry, compensation, or transaction strategy.

Keep axum/tonic routes, serde DTOs, and OpenAPI/protobuf contracts in app or an interfaces crate.
