---
name: semantic-km-creator-cn
description: Builds evidence-only Kimball semantic layers for enterprise knowledge from APIs, CLIs, or tables/databases with an HTML decision workbench; emits OKF/YAML. Use when 企业知识、知识建模、KM、semantic-km-creator-cn、semantic-creator、semantic layers, dimensional models, ontology, OKF, 语义层、接口转语义、维度建模或本体.
license: Apache-2.0
metadata:
  language: zh-CN
  translation_of: semantic-km-creator
  version: "0.6.0"
  openclaw:
    homepage: https://github.com/ontology-of-everything/concept-skills/tree/main/skills/cn/semantic-km-creator-cn
---
