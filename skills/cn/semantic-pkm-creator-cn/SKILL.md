...
description: >-
  ...
  Use when 知识萃取、个人知识管理、PKM、semantic-pkm-creator-cn、sce、三层萃取、IPO、场景/概念/实体.
metadata:
  language: zh-CN
  translation_of: semantic-pkm-creator
  openclaw:
    homepage: https://github.com/ontology-of-everything/concept-skills/tree/main/skills/cn/semantic-pkm-creator-cn
---
