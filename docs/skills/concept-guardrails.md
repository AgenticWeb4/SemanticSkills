...
- [skills.sh](https://skills.sh/ontology-of-everything/concept-skills/concept-guardrails)
...
[统一规格与模板](../../skills/concept-guardrails/references/spec-format.md) 以 WYSIWID v1 §4–6 为基线，区分论文语义、本地扩展与旧格式兼容。
