...
仅手动调用 `$claude-md-cn`，根据仓库事实生成或精简 CLAUDE.md。

- 技能：[SKILL.md](../../../skills/cn/claude-md-cn/SKILL.md)
- 版本：0.1.0；[变更记录](../../../qa/cn/claude-md-cn/CHANGELOG.md)
- 验证：`./qa/claude-md-cn/validate.sh`
