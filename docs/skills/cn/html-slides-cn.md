...
`html-slides-cn` · **HTML Slides — Styled Single-File Decks**

> 本文是给人看的中文说明，**不是** `npx skills add` 安装包内容。Agent 加载 [`skills/html-slides-cn/SKILL.md`](../../../skills/cn/html-slides-cn/SKILL.md)。

**Version:** 0.1.1 · Changelog:
[qa/html-slides-cn/CHANGELOG.md](../../../qa/cn/html-slides-cn/CHANGELOG.md)
...
技能默认不触发。只在用户写 `$html-slides-cn` / `/html-slides-cn` 且要做一份 PPT / 胶片 / 汇报 / 授课 / 技术分享时启动；一般性「封面怎么设计好看」之类问题不启动。

```text
$html-slides-cn 15 分钟华为云 DME 产品介绍，对象客户 IT 主管，华为风格浅色，先出大纲
```
...
```bash
npx skills add ./skills/html-slides-cn \
  --skill html-slides-cn \
  --agent cursor \
  --copy -y
```
...
- [skills.sh](https://skills.sh/ontology-of-everything/concept-skills/html-slides-cn)
- [SkillsMP](https://skillsmp.com/) — repo topics `claude-skills`, `claude-code-skill`
- [ClawHub](https://clawhub.ai/agenticweb4/html-slides-cn)
