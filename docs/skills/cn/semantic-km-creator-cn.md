...
`semantic-km-creator-cn` · **Semantic KM Creator — Enterprise Knowledge from APIs & Databases**
...
[qa/semantic-km-creator-cn/CHANGELOG.md](../../../qa/cn/semantic-km-creator-cn/CHANGELOG.md)
...
```bash
./qa/semantic-km-creator-cn/validate.sh
```

## Marketplaces

- ClawHub: `semantic-km-creator-cn` 0.6.0; bundle license MIT-0

## Install

```bash
npx skills add ontology-of-everything/concept-skills \
  --skill semantic-km-creator-cn \
  --agent cursor \
  --copy -y
```
